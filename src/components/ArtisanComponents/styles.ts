...
export const Container = styled.section`
    ...
    .profile_img_join {
        width: 3rem;
        height: 3rem;
        background-image: url("https://images.prismic.io/portifoliovinni/e2636fb1-47f3-48d5-806e-9f5fbcf10c35_Vinnin.png?auto=compress,format");
    ...
    .body_img {
        ...
        width: 28rem;
        height: 100%;
        background-image: url("https://images.prismic.io/portifoliovinni/ef992344-44d2-40eb-b26d-8a5a31299562_Vinicioss_Poseidon_god_in_Ilia_Efimovitch_Repin_art_style_840786d9-b76f-45df-ac20-96432dc45e1f.png?auto=compress,format");
        background-repeat: no-repeat;
        background-size: cover;
        background-position: center;
